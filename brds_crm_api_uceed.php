...
try {
    ...
    $sheetsResponse = file_get_contents('https://script.google.com/macros/s/AKfycbxUe-eASs1QGW7kp66AzX6PlfmOwXV_WsGugacDm4CB1hGWkFgt1_35b6P2I1xwtY6L/exec', false, stream_context_create([
        'http' => [
            'method' => 'POST',
            'header' => [
